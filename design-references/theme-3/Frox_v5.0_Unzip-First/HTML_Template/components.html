...
<html class="scroll-smooth overflow-x-hidden" lang="en">
  ...
  <body class="w-screen relative overflow-x-hidden min-h-screen bg-gray-100 scrollbar-hide components-page dark:bg-[#000]">
    <div class="wrapper mx-auto text-gray-900 font-normal grid scrollbar-hide grid-cols-[257px,1fr] grid-rows-[auto,1fr]" id="layout">
      ...
      <main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
        <div>
          <main class="p-5">
            <h2 class="text-gray-500 header-1 mt-5">Dropdown</h2>
            <div class="dropdown dropdown-hover w-[142px]">
              <label class="cursor-pointer dropdown-label flex items-center justify-between" tabindex="0">
                <div class="flex items-center gap-[11px]"> <img src="/assets/images/icons/icon-export.svg" alt="export icon"><span class="text-normal font-semibold text-gray-500">Browse</span></div><img src="/assets/images/icons/icon-arrow-down.svg" alt="down icon">
              </label>
              <ul class="dropdown-content" tabindex="0">
                <div class="relative menu rounded-box dropdown-shadow bg-color-brands min-w-[237px] mt-[25px] md:mt-[48px] p-[25px] pb-[10px] dark:text-gray-dark-500 dark:border-dark-neutral-border dark:bg-dark-neutral-bg">
                  <div class="border-solid border-b-8 border-x-transparent border-x-8 border-t-0 absolute w-[14px] top-[-7px] border-b-color-brands"></div>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">All Brands</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">News Reviews</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">Financial report</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">Shipping</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">View Catalog</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">Revenue report</span></a>
                  </li>
                  <li class="text-normal"><a class="flex items-center bg-transparent p-0 gap-[7px]" href="#"> <i class="w-4 h-4 grid place-items-center"><img src="/assets/images/icons/icon-verify.svg" alt="icon"></i><span class="text-white hover:text-[#C6CBD9]">Refund requests</span></a>
                  </li>
                </div>
              </ul>
            </div>
            <h2 class="text-gray-500 header-1">Buttons</h2>
            <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4">Button</button>
            <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4">Button</button>
            <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4">Button</button>
            <h2 class="text-gray-500 header-1">Sliders</h2>
            <div class="multi-range flex flex-col gap-y-7 max-w-[320px]">
              <div>
                <input class="relative" id="lower" type="range" min="0" max="100" value="0" step="0.0001"><span class="absolute">14</span>
                <input class="bg-color-brands relative" id="upper" type="range" min="0" max="100" value="100" step="0.0001"><span class="absolute">85</span>
              </div>
              <div class="flex items-center justify-between"><span class="ml-[-3px]">0</span><span class="mr-[-12px]">100</span></div>
            </div>
            <h2 class="text-gray-500 header-1">Badges</h2>
            <div class="flex gap-x-10">
              <div class="flex items-center gap-x-4">
                <div class="text-sm flex items-center justify-center rounded border w-[62px] h-[25px] bg-white border-transparent text-black">Badge</div>
                <div class="w-6 h-6 rounded-full text-xs flex items-center justify-center border bg-white border-transparent text-black">3</div>
              </div>
              <div class="flex items-center gap-x-4">
                <div class="text-sm flex items-center justify-center rounded border w-[62px] h-[25px] bg-[#262626] border-transparent text-[#C4C4C4]">Badge</div>
                <div class="w-6 h-6 rounded-full text-xs flex items-center justify-center border bg-[#262626] border-transparent text-[#C4C4C4]">2</div>
              </div>
              <div class="flex items-center gap-x-4">
                <div class="text-sm flex items-center justify-center rounded border w-[62px] h-[25px] bg-white border-gray-500 text-[#999999]">Badge</div>
                <div class="w-6 h-6 rounded-full text-xs flex items-center justify-center border bg-white border-gray-500 text-[#999999]">4</div>
              </div>
            </div>
            <h2 class="text-gray-500 header-1">Seclectors</h2>
            <input class="checkbox checkbox-primary rounded border-2 w-[18px] h-[18px]" type="checkbox">
            <input class="radio radio-primary border-2" type="radio">
            <h2 class="text-gray-500 header-1">Toggles</h2>
            <div class="flex gap-x-10">
              <label class="flex items-center cursor-pointer" for="toggleInputM"> 
                <div class="relative"> 
                  <input class="sr-only peer" id="toggleInputM" type="checkbox" name="">
                  <div class="block rounded-full w-[56px] h-[32px] bg-color-brands peer-checked:bg-color-brands"></div>
                  <div class="dot absolute left-1 top-1 rounded-full transition h-[24px] w-[24px] bg-[#DCD7FC] peer-checked:bg-white"></div>
                </div>
              </label>
              <label class="flex items-center cursor-pointer pointer-events-none" for="toggleInputS"> 
                <div class="relative"> 
                  <input class="sr-only peer" type="checkbox" name="" id="toggleInputS">
                  <div class="block rounded-full w-[48px] h-[16px] bg-gray-300 peer-checked:bg-[#B2A7FF]"></div>
                  <div class="dot dotS absolute rounded-full transition h-[24px] w-[24px] top-[-4px] left-[-4px] bg-[#B2A7FF] peer-checked:bg-color-brands"></div>
                </div>
              </label>
            </div>
            <h2 class="text-gray-500 header-1">Controls</h2>
            <div class="flex flex-col gap-y-10">
              <div class="tabs tabs-boxed rounded-3xl bg-[#262626]"><a class="tab text-white text-xs capitalize tab-active" href="#">toggle 1</a><a class="tab text-white text-xs capitalize" href="#">toggle 1</a><a class="tab text-white text-xs capitalize" href="#">toggle 1</a></div>
              <div class="flex items-center gap-x-[14px]">
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full bg-gray-400 text-gray-600 pointer-events-none">Control</button>
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full bg-gray-400 text-gray-600 pointer-events-none">Control</button>
                <div class="btn rounded-full capitalize text-sm w-9 h-9 flex items-center justify-center min-h-fit transition-all duration-300 px-0 border-4 border-transparent hover:border-[#B2A7FF] hover:bg-color-brands bg-gray-400 text-gray-600 pointer-events-none"><img class="filter-gray" src="assets/images/icons/icon-add.svg" alt="icon"></div>
              </div>
              <div class="flex items-center gap-x-[14px]">
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full bg-gray-400 text-gray-600 pointer-events-none">Control</button>
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full bg-gray-400 text-gray-600 pointer-events-none">Control</button>
                <div class="btn rounded-full capitalize text-sm w-9 h-9 flex items-center justify-center min-h-fit transition-all duration-300 px-0 border-4 border-transparent hover:border-[#B2A7FF] hover:bg-color-brands bg-gray-400 text-gray-600 pointer-events-none"><img class="hover:invert filter-gray" src="assets/images/icons/icon-x.svg" alt="icon"></div>
              </div>
              <div class="flex items-center gap-x-[14px]">
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full text-gray-600 pointer-events-none">Control</button>
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 rounded-full text-gray-600 pointer-events-none">Control</button>
                <div class="btn rounded-full capitalize text-sm w-9 h-9 flex items-center justify-center min-h-fit transition-all duration-300 px-0 border-4 border-transparent hover:border-[#B2A7FF] hover:bg-color-brands text-gray-600 pointer-events-none"><img class="invert filter-gray" src="assets/images/icons/icon-x.svg" alt="icon"></div>
              </div>
            </div>
            <h2 class="text-gray-500 header-1 mt-5">Breadcrumb</h2>
            ...
            <h2 class="text-gray-500 header-1 mt-5">Category Badge</h2>
            <div class="grid place-items-center rounded w-[18px] h-[18px] bg-yellow"> 
              <p class="font-medium text-gray-1100 text-[11px] leading-[11px]">5</p>
            </div>
            <h2 class="text-gray-500 header-1 mt-5">Users Stack</h2>
            <div class="flex items-center"><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-50" href="seller-details.html"><img class="w-full h-full object-cover" src="assets/images/avatar-layouts-1.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-40 translate-x-[-10px]" href="seller-details.html"><img class="w-full h-full object-cover" src="assets/images/avatar-layouts-2.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-30 translate-x-[-20px]" href="seller-details.html"><img class="w-full h-full object-cover" src="assets/images/avatar-layouts-3.png" alt="user avatar"></a><a class="block rounded-full border-neutral overflow-hidden border-[1.4px] dark:border-gray-dark-100 w-9 h-9 z-20 translate-x-[-30px]" href="seller-details.html"><img class="w-full h-full object-cover" src="assets/images/avatar-layouts-4.png" alt="user avatar"></a>
              <button class="w-9 h-9 rounded-full border-neutral overflow-hidden bg-color-brands grid place-items-center border-[1.4px] dark:border-dark-neutral-border z-10 translate-x-[-40px]" type="button"><img src="assets/images/icons/icon-add-circle.svg" alt="plus icon"></button>
            </div>
            <h2 class="text-gray-500 header-1 mt-5">Upgrade Block
              <div class="rounded-xl bg-neutral py-5 w-fit flex flex-col gap-5 justify-between px-[31px] dark:bg-dark-neutral-border">
                <div class="relative mr-[18px]"><img class="ml-[6px] dark:hidden" src="assets/images/icons/icon-chat-bubble.svg" alt="chat bubble"><img class="hidden ml-[6px] dark:block" src="assets/images/icons/icon-chat-bubble-dark.svg" alt="chat bubble"><img class="w-full h-full object-cover" src="assets/images/hero-layouts.svg" alt="hero"><img class="ml-auto absolute right-0 translate-x-[120%]" src="assets/images/circle-list-1.png" alt="circle list"></div>
                <p class="text-desc text-center text-gray-1100 font-normal mx-auto max-w-[15ch] dark:text-gray-dark-1100">Unlock more information now by Upgrade to<span class="font-bold">&nbsp;PRO</span></p>
                <button class="btn normal-case h-fit min-h-fit transition-all duration-300 border-4 bg-color-brands hover:bg-color-brands hover:border-[#B2A7FF] dark:hover:border-[#B2A7FF] px-5 block border-neutral py-[7px] dark:border-dark-neutral-border">Upgrade Now</button>
            ...
            <h2 class="text-gray-500 header-1 mt-5">Chart Example
              <div>
                <canvas width="400" height="400" id="performanceChart"></canvas>
              </div>
            </h2>
          </main>
