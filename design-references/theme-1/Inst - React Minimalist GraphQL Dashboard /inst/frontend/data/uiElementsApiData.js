...
export const cartProductPropsData = [
  {
    property: 'thumb',
    description: `set the image object of CartProduct, see: <a target="_blank" href="https://nextjs.org/docs/api-reference/next/image">next/image</a> package for use`,
    type: 'object',
    default: '-',
    version: '1.0',
  },
...
export const productCardPropsData = [
  ...
  },
  {
    property: 'thumb',
    description:
      'set product thumb object, src, width and height. See: <a target="_blank" href="https://nextjs.org/docs/api-reference/next/image">next/images</a> for details',
    type: 'object',
    default: '-',
    version: '',
  },
